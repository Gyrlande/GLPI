...
//          $toadd['_no_notif'] = true;
      ...
      ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      //AJOUT : Actions réalisées à la création d'un 
      if (!empty($this->input['intervention_type_installation'])) {
        $query = "ALTER TABLE `glpi_tickets` SET `intervention_type_installation` = 'true'";
        $DB->query($requete);
      }
      ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      //FIN D'AJOUT///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//       "<div id='uploadfiles'><input type='file' name='filename[]' value='' size='60'></div>";
   ...
   **/
   ...
   function showForm($ID, $options=array()) {
      ...
      echo "</tr>";
      ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      //AJOUT : Lien entre ticket et 
       echo "<tr class='tab_bg_1'>";
      if (!$ID
          && Session::haveRight('followup', TicketFollowup::ADDALLTICKET)) {
      ...
      echo "<th width='$colsize3%'>"._('Contrat')."</th>";
      echo "<td width='$colsize2%'>";
      Contract::dropdown(array('name'  => "id_contrat",
                               'value' => $this->fields["id_contrat"]));
      echo "</table>";
      echo "</td></tr>";
      echo "<table class='tab_cadre_fixe' id='mainformtable3'>";
      echo "<tr class='tab_bg_1'>";
      echo "<th width='$colsize1%'>"._('Lieu de l\'intervention')."</th>";
      echo "<td width='$colsize2%'><input type='text' style='width:98%' maxlength=250 name='name' ".
                " value=\"".Html::cleanInputText($this->fields["intervention_lieu"])."\"></td>";

      echo "<th width='$colsize3%'>"._('Jour de l\'intervention')."</th>";
      echo "<td width='$colsize4%'>";
      Html::showDateField("intervention_jour", array('value' => $this->fields['intervention_jour']));
      echo "</td>";
      echo "</tr><tr class='tab_bg_1'>";

      echo "<th width='$colsize1%'>"._('Heure de début')."</th>";
      echo "<td width'$colsize2%'>";
      Dropdown::showHours("intervention_heure_debut", array('value' => $this->fields['intervention_heure_debut']));
      echo "</td>";

      echo "<th width='$colsize3%'>"._('Heure de fin')."</th>";
      echo "<td width'$colsize4%'>";
      Dropdown::showHours("intervention_heure_fin", array('value' => $this->fields['intervention_heure_fin']));
      echo "</td>";
      echo "</tr></table>";

      echo "<table class='tab_cadre_fixe' id='mainformtable3'>";
      echo "<th width='$colsize1%'>"._('Type d\'intervention : ')."</th>";
      echo "</table>";
      echo "<tr class='tab_bg_1'>";
      echo "<th width='$colsize1%'>"._('Installation')."</th>&nbsp&nbsp";
      echo "<td width='$colsize1%'>".Html::getCheckbox(array('name' => "intervention_type_installation",
                                                            'value' => $this->fields['intervention_type_installation']))."</td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
      echo "<th width='$colsize1%'>"._('Réparation')."</th>&nbsp&nbsp";
      echo "<td width='$colsize1%'>".Html::getCheckbox(array('name' => "intervention_type_reparation",
                                                            'value' => $this->fields['intervention_type_reparation']))."</td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
      echo "<th width='$colsize1%'>"._('Administration')."</th>&nbsp&nbsp";
      echo "<td width='$colsize1%'>".Html::getCheckbox(array('name' => "intervention_type_administration",
                                                            'value' => $this->fields['intervention_type_administration']))."</td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
      echo "<th width='$colsize1%'>"._('Formation')."</th>&nbsp&nbsp";
      echo "<td width='$colsize1%'>".Html::getCheckbox(array('name' => "intervention_type_formation",
                                                            'value' => $this->fields['intervention_type_formation']))."</td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";
      echo "<th width='$colsize1%'>"._('Autre')."</th>&nbsp&nbsp";
      echo "<td width='$colsize1%'>".Html::getCheckbox(array('name' => "intervention_type_autre",
                                                            'value' => $this->fields['intervention_type_autre']))."</td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";

      echo "<table class='tab_cadre_fixe' id='mainformtable3'>";
      echo "<tr class='tab_bg_1'>";
      echo "<th width='$colsize1%'>"._('Détail de la panne')."</th>";
      echo "<td width='$colsize2%'>";
      echo "<textarea style='width:100%' cols='45' rows='3' name='intervention_detail_de_la_panne' >".$this->fields["intervention_detail_de_la_panne"].
           "</textarea>";
      echo "</td></tr></table>";

      echo "<table class='tab_cadre_fixe' id='mainformtable3'>";
      echo "<tr class='tab_bg_1'>";
      echo "<th width='$colsize1%'>"._('Détail de la prestation')."</th>";
      echo "<td width='$colsize2%'>";
      echo "<textarea style='width:100%' cols='45' rows='3' name='intervention_detail_de_la_prestation' >".$this->fields["intervention_detail_de_la_prestation"].
           "</textarea>";
      echo "</tr></table>";

      /*echo "<table class='tab_cadre_fixe' id='mainformtable3'>";
      echo "<tr class='tab_bg_1'>";
      echo "<th width='$colsize1%'>"._('Interventant')."</th>";
      echo "<td width='$colsize4%'>";
      User::dropdown("intervention_interventant", array('value' => $this->fields['intervention_intervenant']));
      echo "</td></tr></table>";*/
